...
(() => {
	 ...
	 */
	Pathformer.prototype.lineToPath = (element) => {
		var newElement = {},
			x1 = element.x1 || 0,
			y1 = element.y1 || 0,
			x2 = element.x2 || 0,
	 ...
	 * @return {object}             Data for a `path` element
	 */
	Pathformer.prototype.rectToPath = (element) => {
		var newElement = {},
	 ...
	 * @return {object}             Data for a `path` element
	 */
	Pathformer.prototype.polylineToPath = (element) => {
		var newElement = {},
	 ...
	 * @return {object}             Data for a `path` element
	 */
	Pathformer.prototype.polygonToPath = (element) => {
	 ...
	 * @return {object}             Data for a `path` element
	 */
	Pathformer.prototype.ellipseToPath = (element) => {
		var newElement = {},
	 ...
	 * @return {object}             Data for a `path` element
	 */
	Pathformer.prototype.circleToPath = (element) => {
		var newElement = {},
	 ...
	 */
	Vivus.LINEAR = (x) => x;
	Vivus.EASE = (x) => -Math.cos(x * Math.PI) / 2 + 0.5;
	Vivus.EASE_OUT = (x) => 1 - (1 - x) ** 3;
	Vivus.EASE_IN = (x) => x ** 3;
	Vivus.EASE_OUT_BOUNCE = (x) => {
	...
	Vivus.prototype.setOptions = function (options) {
		...
		this.forceRender = Object.hasOwn(options, "forceRender")
			? !!options.forceRender
			: this.isIE;
		...
		this.ignoreInvisible = Object.hasOwn(options, "ignoreInvisible")
	...
	Vivus.prototype.starter = function () {
		switch (this.start) {
			...
			case "inViewport": {
				var listener = () => {
					if (this.isInViewport(this.parentEl, 1)) {
						this.play();
	 ...
	 * @return {object}         Object of attributes
	 */
	Vivus.prototype.parseAttr = (element) => {
		var attr,
			output = {};
